function solve() {
    ...
    let bookShelfArr = document.querySelectorAll('.bookShelf');
    let total = 0;
    ...
    function addNewBook(book, year, price) {
        ...
        buyBtn.addEventListener('click', function () {
            ...
            bookShelfArr[1].removeChild(div);
        });
        ...
        bookShelfArr[1].appendChild(div);
    }
    ...
    function addOldBook(book, year, price) {
        ...
        buyBtn.addEventListener('click', function () {
            total += price;
            Array.from(document.querySelectorAll('h1'))[1].textContent = `Total Store Profit: ${total.toFixed(2)} BGN`;
            bookShelfArr[0].removeChild(div);
        });
        div.appendChild(buyBtn);
        bookShelfArr[0].appendChild(div);
    }
